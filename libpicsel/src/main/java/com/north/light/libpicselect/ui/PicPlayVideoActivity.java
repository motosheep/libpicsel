 ...
 * 播放视频activity
 */
public class PicPlayVideoActivity extends PicBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_play_video);
        mVideoPath = getIntent().getStringExtra(IntentCode.CUS_VIDEO_PLAY_PATH);
    ...
    @Override
    public void finish() {
        setResult(IntentCode.CUS_VIDEO_PLAY_RES);
        super.finish();
    }
