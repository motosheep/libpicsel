 ...
 */
public class LibPicClipBitmapUtils {

    private File mOutputFile;

    public LibPicClipBitmapUtils() {
    }
...
//        }
    ...
    public void writeImageToDisk(String filepath, byte[] img) {
        try {
            ...
            if (!f.exists()) {
                LibPicFileUtils.createFile(f, true);
            }
     ...
     * @param bitmap 原始图片
     */
    public boolean saveBitmapInSD(String filename, Bitmap bitmap) {
