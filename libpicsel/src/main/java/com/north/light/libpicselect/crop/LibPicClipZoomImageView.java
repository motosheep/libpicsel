...
public class LibPicClipZoomImageView extends androidx.appcompat.widget.AppCompatImageView implements
        OnScaleGestureListener, OnTouchListener,
        ViewTreeObserver.OnGlobalLayoutListener {

    private static final String TAG = LibPicClipZoomImageView.class.getSimpleName();
    ...
    public LibPicClipZoomImageView(Context context) {
        this(context, null);
    }

    public LibPicClipZoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
                ...
                new SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        ...
                        if (getScale() < SCALE_MID) {
                            LibPicClipZoomImageView.this.postDelayed(
    ...
    private class AutoScaleRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((tmpScale > 1f) && (currentScale < mTargetScale))
                ...
                LibPicClipZoomImageView.this.postDelayed(this, 16);
            } else
            // 设置为目标的缩放比例
            {
    ...
    public void onGlobalLayout() {
        if (once) {
            ...
            mVerticalPadding = (getHeight() - getHeight(widthProportion, heightProportion, getWidth())) / 2;
    ...
    public Bitmap clip() {
        ...
        Bitmap bitmap1 = Bitmap.createBitmap(bitmap, mHorizontalPadding,
                ...
                getHeight(widthProportion, heightProportion, getWidth()));
        // 如果原图 图片还没有回收，强制回收
...
//	}
     ...
     * @return
     */
    public int getHeight(int widthProportion, int heightProportion, int width) {
