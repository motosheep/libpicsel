 ...
 * 描述：handler管理类
 */
public class LibPicHandlerManager implements Serializable {
    private static final String TAG = LibPicHandlerManager.class.getSimpleName();
    //io handler
    ...
    private static final class SingleHolder {
        static final LibPicHandlerManager mInstance = new LibPicHandlerManager();
    }

    public static LibPicHandlerManager getInstance() {
